...
int Interface()
{
	...
	{ 
		cout << "\n\nThank you for your using this soft!\n"; 
...
int Showboard()
{
	...
	for(int i=0;i<16;i++)
	{
		...
		for(int j=0;j<16;j++)				
			cout << map[i][j];
		if(i==6)	cout << "quit: enter 0 0 ";
		if(i==8)	cout << "Step:" << Step;
		if(i==10)	cout << "version: 1.0";
		if(i==12)	cout << "Author: noname"; 
		if(i==14)	cout << "Please input x y pos" ; 
		cout << endl;
